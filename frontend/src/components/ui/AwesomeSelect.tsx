    ...
    return (
        <>
            <button
                ...
                className="w-full flex items-center bg-white/80 border border-slate-300 focus:border-blue-500 text-blue-600 font-mono px-4 py-3 rounded-xl transition-all shadow-[inset_0_0_8px_rgba(37, 99, 235,0.1)] hover:shadow-[0_0_12px_rgba(37, 99, 235,0.2)] justify-between"
            >
                        ...
                        >
                            ...
                            <div className="bg-slate-100 p-4 border-b border-slate-200 flex items-center justify-between shrink-0 shadow-lg">
                                <h3 className="font-black text-slate-900 tracking-widest text-lg uppercase pl-2 flex items-center gap-2">
                                    <span className="w-2 h-2 rounded-full bg-blue-600 shadow-[0_0_10px_rgba(37, 99, 235,1)]"></span>
                                    {placeholder}
                                </h3>
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`w-full text-left px-4 py-4 rounded-xl flex items-center justify-between transition-all font-medium ${
                                                        isSelected 
                                                        ? 'bg-blue-600/20 border border-blue-500 text-blue-600 shadow-[0_0_15px_rgba(37, 99, 235,0.2)]' 
                                                        : 'hover:bg-slate-50 text-slate-600 border border-transparent hover:border-slate-300 hover:text-blue-600'
                                                    }`}
                                                >
                                                    <span className="truncate">{opt.label}</span>
                                                    {isSelected && <Check size={18} className="text-blue-600 shrink-0 shadow-[0_0_10px_rgba(37, 99, 235,0.8)] rounded-full" />}
                                                </button>
                                            );
                                        })}
                                    </div>
